...
class TestToyArchitecture(unittest.TestCase):
    ...
    def test_instruction_memory(self):
        ...
        state.instruction_memory.store_instructions(instructions)
        self.assertEqual(state.instruction_memory.load_instruction(0), instructions[0])
        self.assertEqual(state.instruction_memory.load_instruction(1), instructions[1])
