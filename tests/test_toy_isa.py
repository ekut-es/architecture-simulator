...
class TestToyInstructions(unittest.TestCase):
    ...
    def test_lda(self):
        state = ToyArchitecturalState()
        state.data_memory.store_halfword(1025, MutableUInt16(1))
        state.data_memory.store_halfword(1026, MutableUInt16(25))
        state.data_memory.store_halfword(4095, MutableUInt16(2**16 - 1))
    ...
    def test_add(self):
        state = ToyArchitecturalState()
        state.data_memory.store_halfword(1024, MutableUInt16(1))
        state.data_memory.store_halfword(1025, MutableUInt16(2))
        state.data_memory.store_halfword(1026, MutableUInt16(10))
        state.data_memory.store_halfword(1027, MutableUInt16(2**16 - 1))
    ...
    def test_or(self):
        state = ToyArchitecturalState()
        state.data_memory.store_halfword(1024, MutableUInt16(0x000F))
        state.data_memory.store_halfword(1025, MutableUInt16(0x0EF0))
        state.data_memory.store_halfword(1026, MutableUInt16(0x0100))
        state.data_memory.store_halfword(1027, MutableUInt16(0xFFFF))
    ...
    def test_xor(self):
        state = ToyArchitecturalState()
        state.data_memory.store_halfword(1024, MutableUInt16(0b1101))
        state.data_memory.store_halfword(1025, MutableUInt16(0b1111))
        state.data_memory.store_halfword(1026, MutableUInt16(0xFFFF))
        state.data_memory.store_halfword(1027, MutableUInt16(0x0F0F))
