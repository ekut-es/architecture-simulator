...
class TestSimulation(unittest.TestCase):
    ...
    def test_fibonacci_recursive(self):
        ...
        self.assertEqual(int(fibonacci_recursive(2)), 2)
        self.assertEqual(int(fibonacci_recursive(3)), 3)
        self.assertEqual(int(fibonacci_recursive(4)), 5)
        self.assertEqual(int(fibonacci_recursive(5)), 8)
