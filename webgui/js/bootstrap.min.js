...
!(function (t, e) {
        ...
        off(t, e, s, i) {
            ...
            if (void 0 === o) {
                ...
                for (const [s, i] of Object.entries(c)) {
                    const n = s.replace(C, "");
                    (a && !e.includes(n)) ||
                        x(t, l, r, i.callable, i.delegationSelector);
                }
            } else {
        ...
        V = (t, e = "hide") => {
            ...
            F.on(document, s, `[data-bs-dismiss="${i}"]`, function (s) {
                if (
                    ...
                    return;
                const n =
                    K.getElementFromSelector(this) || this.closest(`.${i}`);
    ...
    class J extends q {
        ...
        _initEvents() {
            this._supportPointerEvents
                ? (F.on(this._element, "pointerdown.bs.swipe", (t) =>
                      this._start(t)
                  ),
                  F.on(this._element, "pointerup.bs.swipe", (t) =>
                      this._end(t)
                  ),
                  this._element.classList.add("pointer-event"))
                : (F.on(this._element, "touchstart.bs.swipe", (t) =>
                      this._start(t)
                  ),
                  F.on(this._element, "touchmove.bs.swipe", (t) =>
                      this._move(t)
                  ),
                  F.on(this._element, "touchend.bs.swipe", (t) =>
                      this._end(t)
                  ));
        }
    ...
    class ct extends W {
        ...
        _addEventListeners() {
            this._config.keyboard &&
                F.on(this._element, "keydown.bs.carousel", (t) =>
                    this._keydown(t)
                ),
                "hover" === this._config.pause &&
                    (F.on(this._element, "mouseenter.bs.carousel", () =>
                        this.pause()
                    ),
    ...
    class xt extends W {
        ...
        _completeHide(t) {
            if (
                !F.trigger(this._element, "hide.bs.dropdown", t)
                    .defaultPrevented
            ) {
    ...
    class Rt extends q {
        ...
        activate() {
            this._isActive ||
                ...
                F.off(document, Ht),
                F.on(document, "focusin.bs.focustrap", (t) =>
    ...
    class ne extends W {
        ...
        show(t) {
            this._isShown ||
                ...
                F.trigger(this._element, Jt, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                (this._isTransitioning = !0),
        ...
        _triggerBackdropTransition() {
            if (
                F.trigger(this._element, "hidePrevented.bs.modal")
                    .defaultPrevented
            )
                return;
            const t =
    ...
    class _e extends W {
        ...
        show(t) {
            this._isShown ||
                F.trigger(this._element, "show.bs.offcanvas", {
                    relatedTarget: t,
                }).defaultPrevented ||
                ((this._isShown = !0),
                this._backdrop.show(),
        ...
        hide() {
            this._isShown &&
                (F.trigger(this._element, "hide.bs.offcanvas")
                    .defaultPrevented ||
                    (this._focustrap.deactivate(),
                    this._element.blur(),
                    (this._isShown = !1),
    ...
    class Ge extends W {
        constructor(t) {
            super(t),
                ...
                this._parent &&
                    ...
                    F.on(this._element, "keydown.bs.tab", (t) =>
                        this._keydown(t)
                    ));
        }
        static get NAME() {
        ...
        show() {
            ...
            const e = this._getActiveElem(),
                s = e
                    ? F.trigger(e, "hide.bs.tab", { relatedTarget: t })
                    : null;
            F.trigger(t, "show.bs.tab", { relatedTarget: e })
                .defaultPrevented ||
