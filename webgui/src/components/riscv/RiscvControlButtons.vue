...
<template>
    <div class="wrapper">
        ...
        <button @click="stepButton();" :disabled="disableStep" id="button-step-simulation" class="btn btn-primary me-1"
            title="single step">
            <i class="bi bi-skip-end-fill"></i>
        </button>
        <button @click="resetButton();" :disabled="disableReset" id="button-reset-simulation" class="btn btn-danger me-1"
            title="reset">
        ...
        <button @click="editorStore.saveTextAsFile();" id="download-button" class="btn btn-secondary me-1" title="download">
