        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-2 text-light" id="settingsModalLabel">
                        Settings
                    </h1>
                </div>
                <div class="modal-body">
                    <div id="isa-selector-settings-container" class="border-bottom mb-2">
                        <RadioSettingsRow v-model="selectedIsa"
                            :default-selection="globalSettings.selectedIsa" :option-names="['RISC-V', 'Toy']"
                            :option-values="['riscv', 'toy']" :base-id="'isa-selector'" :display-name="'ISA'">
                        </RadioSettingsRow>
                    </div>
