...
def update_register_table(reg: int, val: int) -> None: ...
...
def update_instruction_table(address, val) -> None: ...
def clear_memory_table() -> None: ...
#def update_performance_metrics(performance_metrics: str) -> None: ...
